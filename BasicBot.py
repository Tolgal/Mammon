...
@bot.command(pass_context=True, brief='Allows an user to set up a mission in the #mission-sandbox channel', description='Type "!host_mission [message]" to display the message in #mission-sandbox. Use !stop_hosting to remove the message.')
...
@bot.command(pass_context=True, brief='Deletes your current host message', description='Deletes your current !host_mission message in #mission-sandbox')
